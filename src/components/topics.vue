    ...
    <div class="topicsContent">
      <nav>
        <ul>
          ...
          <li><a :class="{'active': active_item === 'weex' }" @click="select('weex');cut('weex')">weex</a></li>
        ...
        <div class="article" v-for="topic in topicitems.data">
          ...
          <div class="article_middle">
            <div class="tags">
              ...
              <span v-show="topic.tab === 'weex'">weex</span>
    ...
    export default{
      ...
      methods: {
        ...
        cut (type) {
          ...
          this.Tab = type
          this.pageNum = 1
          this.axios.get('https://www.vue-js.com/api/v1/topics' + '?tab=' + type).then((response) => {
      ...
      created () {
        NProgress.start()
        this.axios.get('https://www.vue-js.com/api/v1/topics').then((response) => {
          this.topicitems = response.data
          NProgress.done()
        })
      },
